...
private:
  ...
  bool query(QueryGlobalLocalizationRequest& req, QueryGlobalLocalizationResponse& res) {
    ...
    // /home/wzh/ros1_ws/src/hdl_global_localization/src/hdl_global_localization/engines/global_localization_bbs.cpp 53
    auto results = engine->query(cloud, req.max_num_candidates, req.lat, req.lon);
